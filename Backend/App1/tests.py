...
class StoreAPIsTestCase(TestCase):
    ...
    def test_api_category_list(self):
        response_1 = client_get('CategoryList', {})
        response_2 = client_get('CategoryList', {"search_key": ""})
        response_3 = client_get('CategoryList', {"search_key": "vehicle"})
        response_4 = client_get('CategoryList', {"search_key": "g"})
        response_5 = client_get('CategoryList', {"search_key": "oo"})
        response_6 = client_get('CategoryList', {"search_key": "clothes"})
    ...
    def test_api_subcategory_list(self):
        response_1 = client_get('SubCategoryList', {})
        response_2 = client_get('SubCategoryList', {"search_key": ""})
        response_3 = client_get('SubCategoryList', {"search_key": "car"})
        response_4 = client_get('SubCategoryList', {"search_key": "Gta"})
        response_5 = client_get('SubCategoryList', {"search_key": "ts"})
        response_6 = client_get('SubCategoryList', {"search_key": "p", "category_id": 3})
        response_7 = client_get('SubCategoryList', {"category_id": 4})
        response_8 = client_get('SubCategoryList', {"search_key": "", "category_id": 1})
    ...
    def test_api_product_list(self):
        response_1 = client_get('ProductList', {})
        response_2 = client_get('ProductList', {"search_key": ""})
        response_3 = client_get('ProductList', {"search_key": "la"})
        response_4 = client_get('ProductList', {"search_key": "la", "subcategory_id": 1})
        response_5 = client_get('ProductList', {"search_key": "la", "category_id": 2})
        response_6 = client_get('ProductList', {"search_key": "la", "category_id": 2, "subcategory_id": 4})
        response_7 = client_get('ProductList', {"search_key": "gta", "category_id": 3})
        response_8 = client_get('ProductList', {"search_key": "gta"})
        response_9 = client_get('ProductList', {"category_id": 3, "subcategory_id": 2})
        response_10 = client_get('ProductList', {"category_id": 3, "subcategory_id": 8})
    ...
    def test_api_the_category(self):
        response_1 = client_get('TheCategory', {})
        response_2 = client_get('TheCategory', {"id": "four"})
        response_3 = client_get('TheCategory', {"id": 8})
        response_4 = client_get('TheCategory', {"id": 2})
        response_1_result = {'status': 'requiredParams',
    ...
    def test_api_the_subcategory(self):
        response_1 = client_get('TheSubCategory', {})
        response_2 = client_get('TheSubCategory', {"id": "four"})
        response_3 = client_get('TheSubCategory', {"id": 26})
        response_4 = client_get('TheSubCategory', {"id": 2})
        response_1_result = {'status': 'requiredParams',
                             'error_type': "[<class 'TypeError'>]",
                             'error_on': '[TypeError("int() argument must be a string, a bytes-like object or a number, not \'NoneType\'",)]',
                             'success': '0'}
    ...
    def test_api_the_product(self):
        response_1 = client_get('TheProduct', {})
        response_2 = client_get('TheProduct', {"id": "four"})
        response_3 = client_get('TheProduct', {"id": 74})
        response_4 = client_get('TheProduct', {"id": 2})
        response_1_result = {'status': 'requiredParams',
                             'error_type': "[<class 'TypeError'>]",
                             'error_on': '[TypeError("int() argument must be a string, a bytes-like object or a number, not \'NoneType\'",)]',
                             'success': '0'}
